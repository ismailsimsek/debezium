 ...
 * </ul>
 */
public abstract class AbstractExternalSignalThread<P extends Partition, T extends DataCollectionId> implements ExternalSignalThread {
    ...
    protected final AbstractReadOnlyIncrementalSnapshotChangeEventSource<P, T> eventSource;
    ...
    public AbstractExternalSignalThread(CommonConnectorConfig connectorConfig,
                                        AbstractReadOnlyIncrementalSnapshotChangeEventSource<P, T> eventSource) {
