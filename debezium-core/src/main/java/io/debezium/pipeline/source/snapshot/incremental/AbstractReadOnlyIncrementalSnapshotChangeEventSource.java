 ...
 */
@NotThreadSafe
public abstract class AbstractReadOnlyIncrementalSnapshotChangeEventSource<P extends Partition, T extends DataCollectionId>
    ...
    public AbstractReadOnlyIncrementalSnapshotChangeEventSource(RelationalDatabaseConnectorConfig config,
        ...
        try {
            ...
            Class<? extends AbstractExternalSignalThread<P, T>> connectorClass = (Class<AbstractExternalSignalThread<P, T>>) getClass().getClassLoader()
