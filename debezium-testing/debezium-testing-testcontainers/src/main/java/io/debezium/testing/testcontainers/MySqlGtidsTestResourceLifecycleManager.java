 ...
 * @author Oren Elias
 */
public class MySqlGtidsTestResourceLifecycleManager implements QuarkusTestResourceLifecycleManager {
    ...
    public static final String IMAGE = "debezium/example-mysql-gtids";
