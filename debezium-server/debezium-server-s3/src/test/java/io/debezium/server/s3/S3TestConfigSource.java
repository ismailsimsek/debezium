...
public class S3TestConfigSource extends TestConfigSource {
    ...
    public S3TestConfigSource() {
        ...
        s3Test.put("debezium.sink.s3sparkbatch.saveformat", "parquet");
        // spark conf
        ...
        s3Test.put("debezium.sink.s3sparkbatch.spark.hadoop.fs.s3a.endpoint", "http://localhost:" + TestS3MinioServer.MINIO_DEFAULT_PORT_MAP);
