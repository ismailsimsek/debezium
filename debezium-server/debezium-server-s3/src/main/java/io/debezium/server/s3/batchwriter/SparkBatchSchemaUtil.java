...
public class SparkBatchSchemaUtil {
     ...
     */
    private static final Map<Schema.Type, DataType> SCHEMA_TYPE_CLASSES = new EnumMap<>(
            Schema.Type.class);
    /**
    ...
    static {
        SCHEMA_TYPE_CLASSES.put(Schema.Type.INT8, IntegerType);
        SCHEMA_TYPE_CLASSES.put(Schema.Type.INT16, IntegerType);
        SCHEMA_TYPE_CLASSES.put(Schema.Type.INT32, IntegerType);
        SCHEMA_TYPE_CLASSES.put(Schema.Type.INT64, IntegerType);
        /*
